...
def preprocess_image(
    ...
    if preprocessing == Preprocessing.YAHOO:
        ...
        with managed_bytes_io() as fh_im:
            ...
            image = image[h_off : h_off + h, w_off : w_off + w, :]  # noqa
...
async def preprocess_image_async(
    ...
    processed_image = await to_thread(preprocess_image, pil_image, preprocessing)
